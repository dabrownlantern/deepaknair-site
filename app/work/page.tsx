...
export const metadata: Metadata = {
  title: "Work",
  description:
    "Case studies: building the creator ecosystem at Roblox, founding the DevRel org for Fortnite Creative, and publishing strategy for a licensed-IP slate at Nitrate Games.",
};
    ...
    <>
      <section className="container-x pt-16 pb-12 md:pt-24">
        ...
        <h1 className="mt-5 max-w-3xl font-display text-h1 text-paper md:text-display">
          Built creator ecosystems from zero. Three times.
        </h1>
